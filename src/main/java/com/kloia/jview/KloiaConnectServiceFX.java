...
/**
 * AWS Connect CCP Service with embedded SwingNode for JavaFX
 *
 * This version embeds JCEF directly into a SwingNode that can be placed
 * in a JavaFX layout. Note: Due to JCEF/SwingNode rendering limitations,
 * the browser will appear as a black screen visually, but it functions
 ...
 *     if (success) {
 *         // Add SwingNode to your layout
 *         yourPane.getChildren().add(service.getBrowserNode());
 *     }
 * });
 * </pre>
 */
public class KloiaConnectServiceFX {
    ...
    // SwingNode for embedding in JavaFX
    private SwingNode browserNode;
    private JPanel browserPanel;

    // Hidden JFrame to host JCEF (required for rendering)
    ...
    /**
     * Get the SwingNode containing the JCEF browser
     * Note: Will appear as black screen but functions correctly
     */
    public SwingNode getBrowserNode() {
        return browserNode;
    }
    ...
    public void start(Consumer<Boolean> onComplete) {
        ...
        new Thread(() -> {
            try {
                ...
                // JCEF requires a visible window to function
                // Create hidden JFrame off-screen to host the browser
                SwingUtilities.invokeLater(() -> {
                    // Hidden frame for JCEF (off-screen, no taskbar)
                    ...
                    // SwingNode gets a placeholder panel (will show black)
                    JPanel placeholderPanel = new JPanel();
                    placeholderPanel.setBackground(Color.BLACK);
                    browserNode.setContent(placeholderPanel);
                });
    ...
    private void updateStatus(String status) {
        System.out.println("[KloiaConnectServiceFX] " + status);
    ...
    private void initializeCEF() throws Exception {
        ...
        msgRouter.addHandler(new CefMessageRouterHandlerAdapter() {
            ...
            public boolean onQuery(CefBrowser browser, CefFrame frame, long queryId, String request,
                ...
                System.out.println("[KloiaConnectServiceFX] EVENT: " + request);
        ...
        client_.addDisplayHandler(new CefDisplayHandlerAdapter() {
            ...
            public void onAddressChange(CefBrowser browser, CefFrame frame, String url) {
                System.out.println("[KloiaConnectServiceFX] Navigated to: " + url);
            }
